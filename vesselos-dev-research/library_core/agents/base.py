...
class BaseAgent(ABC):
    ...
    async def log_event(self, log_type: str, entry: Dict[str, Any]) -> None:
        """Compatibility helper mirroring the Kira Prime logging API."""
        await self.append_log(log_type, entry)
