...
from echo_soulcode.validate import validate_obj
...
def test_validate_auto_detect_single():
    rep = validate_obj(minimal_single(), "auto")
    assert rep.ok and rep.kind == "soulcode"

def test_validate_single_explicit():
    rep = validate_obj(minimal_single(), "soulcode")
    assert rep.ok
